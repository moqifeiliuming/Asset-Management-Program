...
public class AssetsUsing extends JPanel implements ActionListener, ListSelectionListener {
    ...
    public void Init() throws Exception {
        ...
        //中部面板的布局
        String[][] colValue = assetsDao.findAllUsingOverTypeID();
        if (colValue == null) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == receiveInfo) {
            try {
                ...
                System.out.println("|领用ID号为: " + ID1);
                assetsDao.modifyUsing(new Assets("领用",Integer.parseInt((String)jTable.getValueAt(selectedRow,0))));
                assetsTrjnDao.add1(new AssetsTrjn(Integer.parseInt((String)jTable.getValueAt(selectedRow,0)),
