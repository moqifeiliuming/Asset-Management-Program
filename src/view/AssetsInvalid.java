...
public class AssetsInvalid extends JPanel implements ActionListener, ListSelectionListener {
    ...
    public void Init() throws Exception {
        ...
        //中部面板的布局
        String[][] colValue = assetsDao.findAllUsingByType();
        if (colValue == null) {
...
//                jComboBox1.addItem(s1[i][1]);
    ...
    public void downInit() {
        ...
        receiveInfo.setText("废弃");
        receiveInfo.setFont(new Font("Dialog", 0, 12));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == receiveInfo) {
            try {
                ...
                assetsDao.modifyUsing(new Assets("报废",Integer.parseInt((String)jTable.getValueAt(selectedRow,0))));
                assetsTrjnDao.add3(new AssetsTrjn(Integer.parseInt((String)jTable.getValueAt(selectedRow,0)),
                        Integer.parseInt(ID),
